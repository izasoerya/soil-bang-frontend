...
class SensorBodySection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        _buildSectionHeader('Visible Spectrum', '410nm – 705nm', AppColors.cyanLine),
        _buildChart(context, visibleSpots,
            minX: 400, maxX: 710, lineColor: AppColors.cyanLine, intervalX: 50),

        const SizedBox(height: 20),

        _buildSectionHeader('Near-Infrared', '730nm – 940nm', AppColors.redLine),
        _buildChart(context, irSpots,
            minX: 720, maxX: 950, lineColor: AppColors.redLine, intervalX: 50),

        const SizedBox(height: 24),

        _buildSectionHeader('Raw Channel Matrix', 'μW/cm²', AppColors.textSecondary),
